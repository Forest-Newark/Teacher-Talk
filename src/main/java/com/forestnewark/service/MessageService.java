...
public class MessageService {
    ...
    final String username = "forestjavadev@gmail.com"; //Enter email login username - IE. name@gmail.com
    final String password = "st7SpudaS"; //Enter email login password - IE. 123Password
